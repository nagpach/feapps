 ...
 * })
 */
export const mockGetMeQuery = (resolver: ResponseResolver<GraphQLRequest<GetMeQueryVariables>, GraphQLContext<GetMeQuery>, any>) =>
 ...
 * })
 */
export const mockLoginUserMutation = (resolver: ResponseResolver<GraphQLRequest<LoginUserMutationVariables>, GraphQLContext<LoginUserMutation>, any>) =>
  graphql.mutation<LoginUserMutation, LoginUserMutationVariables>(
    'LoginUser',
    resolver
  )
 ...
 * })
 */
export const mockLogoutUserQuery = (resolver: ResponseResolver<GraphQLRequest<LogoutUserQueryVariables>, GraphQLContext<LogoutUserQuery>, any>) =>
  graphql.query<LogoutUserQuery, LogoutUserQueryVariables>(
    'LogoutUser',
    resolver
  )
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockRefreshAccessTokenQuery((req, res, ctx) => {
 *   return res(
 *     ctx.data({ refreshAccessToken })
 *   )
 * })
 */
export const mockRefreshAccessTokenQuery = (resolver: ResponseResolver<GraphQLRequest<RefreshAccessTokenQueryVariables>, GraphQLContext<RefreshAccessTokenQuery>, any>) =>
  graphql.query<RefreshAccessTokenQuery, RefreshAccessTokenQueryVariables>(
    'RefreshAccessToken',
    resolver
  )
 ...
 * })
 */
export const mockSignUpUserMutation = (resolver: ResponseResolver<GraphQLRequest<SignUpUserMutationVariables>, GraphQLContext<SignUpUserMutation>, any>) =>
  graphql.mutation<SignUpUserMutation, SignUpUserMutationVariables>(
    'SignUpUser',
    resolver
  )
