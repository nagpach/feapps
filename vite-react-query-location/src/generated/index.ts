...
export const LaunchesPastDocument = `
    query LaunchesPast {
  launchesPast(limit: 10) {
    ...
    `;
export const useLaunchesPastQuery = <
      TData = LaunchesPastQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables?: LaunchesPastQueryVariables,
      options?: UseQueryOptions<LaunchesPastQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<LaunchesPastQuery, TError, TData>(
      variables === undefined ? ['LaunchesPast'] : ['LaunchesPast', variables],
