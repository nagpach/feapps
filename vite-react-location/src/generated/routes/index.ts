...
export type LaunchesPastQuery = { __typename?: 'Query', launchesPast?: Array<{ __typename?: 'Launch', mission_name?: string | null, launch_date_local?: any | null, launch_site?: { __typename?: 'LaunchSite', site_name_long?: string | null } | null } | null> | null };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    LaunchesPast(variables?: LaunchesPastQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<LaunchesPastQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<LaunchesPastQuery>(LaunchesPastDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'LaunchesPast', 'query');
    }
  };
}
